<div class="main-sidebar">
  ...
  <a href="{{ route('admin.dashboard.index') }}">E-Library</a>
</div>

<div class="sidebar-brand sidebar-brand-sm">
  <a href="{{ route('admin.dashboard.index') }}">EL</a>
</div>
    <ul class="sidebar-menu">
      ...
      @else
      <div class="sidebar-brand">
        <a href="{{ route('anggota.dashboard.index') }}">e-Library</a>
      </div>
      <div class="sidebar-brand sidebar-brand-sm">
        <a href="{{ route('anggota.dashboard.index') }}">eL</a>
      </div>
      <ul class="sidebar-menu">
        <li class="{{ Request::segment(2) === 'dashboard' ? 'active' : '' }}">
